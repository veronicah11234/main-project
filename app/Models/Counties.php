...
class Counties extends Model
{
    ...
    // Add static method to seed counties data
    // public static function seedCounties()
    // {
    //     foreach (self::$counties as $countyData) {
    //         self::create([
    //             'counties_id' => $countyData['counties_id'],
    //             'counties_name' => $countyData['counties_name'],
    //             'country_id' => $countyData['country_id'],
    //         ]);
    //     }
    // }
    ...
    // ];
    // public static function getCountiesData()
    // {
