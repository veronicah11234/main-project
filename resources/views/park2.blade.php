...
<div class="container">
  ...
  <div class="container">
    <div class="row">
        ...
        <p style="color: rgb(3, 114, 3)">
            4 Days Masai Mara Lake-Nakuru safari tour is one of our best yet popular Nairobi road safari program intended for bird watching and unimaginable wildlife viewing.
             This 4 days Tour to Lake Nakuru & Masai Mara will start from Nairobi and end in Nairobi.
        </p>

        </div>
        <div class="col-4">
         <h1>4 Days Masai Mara Lake Nakuru Safari from Nairobi</h1><br><br>
         <h1>African Safari Tours In Kenya</h1>
    <ul>
      <li>Mombasa Road Safaris</li>
      <li>Diani Safaris Tour packages</li>
      <li>Kenya Beach Safaris</li>
      <li>Mombasa Air Safari Packages</li>
      <li>Nairobi Road Safaris</li>
      <li>Nairobi Air Safaris</li>
    </ul>
    ...
    <div class="row" style="border: 2px">
        <div class="col-8">
            ...
            <p style="color:rgb(88, 95, 95)">
                Depart from Nairobi in the morning and drive to the view point of the rift valley. Enjoy the scenery & take photos.
                 Descend to the floor of the rift valley and drive via Narok town to Masai Mara game reserve. Arrive in time for lunch. Afternoon game drive. Dinner and overnight in a lodge / Luxury camp of your choice.
            </p><br><br>

            <h2>Day 2: Masai Mara </h2>
            <p style="color:rgb(88, 95, 95)">
