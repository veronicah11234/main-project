...
@section('content')
    ...
    <div class="card">
        ...
        <div class="row">
            <div class="col-sm-3 ">
                <img src="/images/park1.png" alt="Images" class="img-fluid">
            </div><br/>
            
            <div class="col-sm-3 ">
                <img src="/images/park2.png" alt="Images" class="img-fluid">
            </div><br/>
            <div class="col-sm-3 ">
                <img src="/images/park3.png" alt="Images" class="img-fluid">
            </div><br/>
            <div class="col-sm-3 ">
                <img src="/images/park4.png" alt="Images" class="img-fluid">
            </div><br/>
            ...
            <div class="col-sm-3 ">
                <img src="/images/park6.png" alt="Images" class="img-fluid">
            </div><br/>
            <div class="col-sm-3 ">
                <img src="/images/park7.png" alt="Images" class="img-fluid">
            </div><br/>
            <div class="col-sm-3 ">
                <img src="/images/park8.png" alt="Images" class="img-fluid">
            </div><br/>
    
            
            <div class="col-sm-3 ">
                <img src="/images/park9.png" alt="Images" class="img-fluid">
            </div><br/>
            <div class="col-sm-3 ">
                <img src="/images/park10.png" alt="Images" class="img-fluid">
            </div><br/>
            <div class="col-sm-3 ">
                <img src="/images/park11.png" alt="Images" class="img-fluid">
            </div><br/>
            <div class="col-sm-3 ">
                <img src="/images/park12.png" alt="Images" class="img-fluid">
            </div><br/>
            </div>
        </div>
        </div>
